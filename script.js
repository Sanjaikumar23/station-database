...
form.addEventListener('submit', function (event) {
    ...
    const area = formData.get('area');
     ...
     if (!country || !state || !district || !area) {
        alert('Please select all fields');
        return;
    }

    // You can replace this with actual data fetching logic from JSON
    let stationData = {};
    if (country === 'India' && state === 'Tamil Nadu' && district === 'Chennai' && area === 'Velachery') {
        stationData = {
            'station-name': 'Velachery',
            'telephone-number': '451214551',
            'phone-number': '789954455',
            'email': 'jfhfhfkd@gmail.com',
            'location': 'Velcher 4th Street',
            'live-location': 'url'
        };
    } else if (country === 'India' && state === 'Tamil Nadu' && district === 'Chennai' && area === 'Adyar') {
        stationData = {
            'station-name': 'Adyar',
            'telephone-number': 'no-33e annjugam ammaiyar nagar',
            'phone-number': '44588524',
            'email': 'gdfdyudb@gmail.com',
            'location': 'Adyar 5th Street',
            'live-location': 'url'
        };
    }   else if (country === 'India' && state === 'Tamil Nadu' && district === 'Chennai' && area === 'Perungudi') {
        stationData = {
            'station-name': 'Perungudi',
            'telephone-number': '456612',
            'phone-number': '44588524',
            'email': 'perungudi.com',
            'location': 'Adyar 5th Street',
            'live-location': 'link'
        };
    } else if (country === 'India' && state === 'Tamil Nadu' && district === 'Chennai' && area === 'Anna Nagar') {
        stationData = {
            'station-name': 'Anna Nagar',
            'telephone-number': '456612',
            'phone-number': '44588524',
            'email': 'Annanagar.com',
            'location': 'Adyar 5th Street',
    ...
    for (const key in stationData) {
        ...
        if (inputElement) {
            inputElement.value = stationData[key];
        }
    }

    // Show the result container and back button
